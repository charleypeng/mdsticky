...
//  mdsticky
//
//  Sync to a Samba / SMB share via a mounted path.
//  The user is responsible for mounting the share first.
//  Supports security-scoped bookmarks for sandboxed folder access.
//

import Foundation

final class SambaSyncService: SyncServiceProtocol {
